...
namespace rhBugTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        {
            var ticketComments = db.TicketComments.Include(t => t.OwnerUser).Include(t => t.Ticket);
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,OwnerUserId,Comment,Created")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,OwnerUserId,Comment,Created")] TicketComment ticketComment)
        {
            if (ModelState.IsValid)
            {
